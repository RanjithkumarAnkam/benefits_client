    ...
    <div class="left-menu-inner scroll-pane">
        <ul class="left-menu-list left-menu-list-root list-unstyled">
          ...
          <li class="left-menu-list-color-primary" id="dashboard">
            ...
            <li class="left-menu-list-color-success"  id="admin_users">
			 ...
			 <li class="left-menu-list-submenu left-menu-list-color-warning" id="firms_id">
                ...
                <ul class="left-menu-list list-unstyled" id="firms_id_ul">
                    ...
                    <li class="firms_pricing_li">
                        <a class="left-menu-link firm_a" href="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/admin/firm/firmpricing">
                             Firm Pricing
                        </a>
                    </li>
            ...
            <li class="left-menu-list-submenu left-menu-list-color-info" id="master_data">
                ...
                <ul class="left-menu-list list-unstyled"  id="master_data_ul">
					...
					<li  class="lookup_li">
                        <a class="left-menu-link lookup_a" href="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/admin/masterdata/lookupoptions">
                            Lookup Options
                        </a>
                    </li>
