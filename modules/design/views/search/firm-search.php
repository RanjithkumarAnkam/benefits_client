		...
		<div class="dashboard-container">
			...
			<div class="col-md-12 col-xs-12 header-main">
				<div class="col-md-12 col-xs-12">
					<span class="font-18">Search Firm / Company Users</span> <span
					...
					<p class="box-head">Search Results</p>
							...
							<div class="col-md-12 box-border box-padding">
									<div class="demo-container" ng-app="DemoApp"
										...
										<div dx-data-grid="dataGridOptionsfirm"></div>
									</div>
									</div>
								</div>
				</div>
...
<script type="text/javascript"
	src="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/themes/dev-express/js/firm-search.js"></script>