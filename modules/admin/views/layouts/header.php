			...
			<div class="dropdown dropdown-avatar">
				...
				<ul class="dropdown-menu dropdown-menu-right" aria-labelledby=""
					...
					<a class="dropdown-item"
						href="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/site/logout"><i
		...
		<div class="menu-info-block">
			<div class="left">
				<div class="header-buttons">
					<div class="typeahead__container pull-left padding-right-20">
						<div class="typeahead__field">
							<div class="typeahead__query">
								<div class="input-group">
									<input id="example1" class="form-control" name="" type="text"
										placeholder="Login to Firms" autocomplete="off" style="width:auto;" /> <span
										class="input-group-btn" style="width:auto;"> <a href="javascript: void(0);"
					...
					<div class="typeahead__container  pull-left">
						<div class="typeahead__field">
							<div class="typeahead__query">
								<div class="input-group">
									<input id="example1" class="form-control" name="" type="text"
										placeholder="Login to Clients" autocomplete="off"  style="width:auto;"/> <span
										class="input-group-btn" style="width:auto;"> <a href="javascript: void(0);"
										class="btn btn-info"> Login </a>
									</span>
								</div>
					...
					<!-- <div class="dropdown">
						<a href="javascript: void(0);"
							...
							class="hidden-lg-down">Dashboard</span> <span class="caret"></span>
						</a>
						<!--   <ul class="dropdown-menu" aria-labelledby="" role="menu">
