...
<script src="https://code.highcharts.com/modules/exporting.js"></script>
			...
			<div class="blue-breadcrumb col-md-12 padding-0">
				...
				<div class="breadcrumb-description">
					<span class="">Master Data &gt; <a class="color-white" href="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/design/firm-plan/client-plan-years?id=1"><u>Manage Plans - Group Medical - Prior (2016)</u></a> &gt; Level Funded</span>
															...
															<div class="col-md-4">
																<div class="form-group ">
																			...
																			<input
																				...
																				value="Level Funded Insured" placeholder="e.g. Level Funded Insured (since this is partially level funded medical)" disabled>
				...
				<div class="tab-pane" id="cost_projections_block">
					<div class="col-md-12  padding-10 ul-block">
						<ul class="nav nav-pills nav-wizard">
							...
							<li href="#claims_project_assumption" data-toggle="tab" class="active inner-block-li" id="anchor-pb-7"><a><div class="inner-block-digits pull-left">1</div><span class="inner-block-text">Renewal Claims Projection Assumptions</span></a></li>
							<li href="#cost_project_assumption" data-toggle="tab" class="inner-block-li" id="anchor-pb-8"><a><div class="inner-block-digits pull-left">2</div><span class="inner-block-text" title="Renewal Cost Item Renewal Assumptions">Renewal Cost Item Renewal...</span></a></li>
					...
					<div class="tab-content clearfix">
						...
						<div class="border-top-bottom-ddd col-md-12 padding-0">
                            ...
                            <tr>
							 ...
							 <tr>
                               <td class="header-td">Pooling Charges</td>
                               <td class="column-1 column-td" id="1">$200</td>
                                <td class="column-2 column-td" id="2">$50</td>
                                <td class="column-3 column-td" id="3">$250</td>
                                <td class="column-4 column-td" id="4">$250</td>
...
$filteredresultData = array_filter($resultData, 'filter_4');
