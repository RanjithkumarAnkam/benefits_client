        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="cwt__footer__company">
                    <img class="cwt__footer__company-logo" src="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/build/assets/common/img/temp/mediatec.png" target="_blank" title="Mediatec Software">
                    <span>
