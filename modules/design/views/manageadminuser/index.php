...
?>
	...
	<div class="col-md-12 col-xs-12 header-main">
				<div class="col-md-12 col-xs-12">
					<span style="font-size: 18px;">Manage BC Users</span> <span
...
<script type="text/javascript"
	...
	$(document).ready( function (){
		$("#admin_users").addClass("left-menu-list-opened");
		 $(".dx-toolbar-before").html('<strong class="font-16">Manage BC Users</strong>');
	});
