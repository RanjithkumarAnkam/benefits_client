	...
	<div class="page-content-inner">
		...
		<div class="dashboard-container"  ng-app="DemoApp" ng-controller="DemoController">
			...
			<div class="header-main">
				<span class="font-22">Claims Input</span><a href="<?php echo Yii::$app->getUrlManager()->getBaseUrl();  ?>/clients/manageplans?id=2" class="btn btn-success pull-right line-height-13"> Back</a>
			</div>
...
<script type="text/javascript"
	src="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/js/firm/dental/dental-partial.js"></script>
