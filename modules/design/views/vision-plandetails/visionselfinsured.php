	...
	<div class="page-content-inner">
		...
		<div class="dashboard-container">
			...
			<div class="header-main" id="header">
				<span class="font-18">Plan Details</span><a href="<?php echo Yii::$app->getUrlManager()->getBaseUrl();  ?>/clients/manageplans?id=3" class="btn btn-success pull-right line-height-13"> Back</a>
			</div>
			<div class="col-md-12">
							...
							<div class="col-md-6">
								...
								<div class="col-md-6">
									...
									<div class="form-group form-md-line-input form-md-floating-label has-success margin-bottom-5">
										<input type="text" required="" value="Self Insured" class="form-control borders"> <label
														...
														<div class="panel-body">
															...
															<div class="">
																<div class="demo-container" >
																	<div dx-data-grid="dataGridOptionsvisionselfinsured"></div>
																</div>
															</div>
...
<script type="text/javascript"
	src="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/js/firm/visionplandetails.js"></script>