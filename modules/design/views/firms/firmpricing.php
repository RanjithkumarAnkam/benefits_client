...
$("#firms_id").addClass("left-menu-list-opened");
	 $("#firms_id_ul").css("display","block");
	 $("#firms_id_ul  li.firms_pricing_li a.firm_a").css("color","black");
	 
	 $(".dx-toolbar-before").html('<strong class="font-16">Firm Pricing</strong>');
});
</script>