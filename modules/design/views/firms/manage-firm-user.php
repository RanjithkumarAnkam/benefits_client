		...
		<div class="dashboard-container">
			...
			<div class="col-md-12 col-xs-12 header-main">
				<div class="col-md-12 col-xs-12">
					<span class="font-18">Manage Firm Users</span> <span
			...
			<!-- Basic Form Elements -->
				...
				<div class="row padding-bottom-20">
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="aplhabets-div  margin-top-10 margin-bottom-10">
				...
				<div class="hide col-md-12 div-search">
...
<script type="text/javascript"
	src="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/js/firm/managefirms.js"></script>