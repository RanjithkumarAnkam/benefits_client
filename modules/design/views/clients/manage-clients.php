		...
		<div class="dashboard-container">
			...
			<div class="col-md-12 col-xs-12 header-main">
				<div class="col-md-12 col-xs-12">
					<span class="font-18">Search</span> <span
			...
			<!-- Basic Form Elements -->
				...
				<div class="row padding-bottom-20">
					...
					<div class="search-block data-count">		
						<i class="fa fa-exclamation-triangle"></i>5 Results Found
					</div>						
					</div>		
					<div class="col-lg-12">
					<div class="row">
...
<script type="text/javascript"
	src="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/js/client/manageclients.js"></script>