...
-->											
								...
								<div class="col-md-6">
									...
									<div class="form-group form-md-line-input form-md-floating-label has-success margin-bottom-5">
										<input type="text" required="" value="Partially Self Insured" class="form-control borders"> <label
							...
							<section class="padding-0">
								<div
									class="col-lg-12 col-xs-12 padding-bottom-10 padding-left-0">
									...
									<div
										...
										<div class="panel-body">
										<h6 class="col-md-12 margin-top-10">Enter Reinsurance Details</h6>
											<div class="col-md-12">
												<div class="col-md-6">
									<div
										class="form-group form-md-line-input form-md-floating-label has-success margin-bottom-5">
										<input type="text" required="" value="" class="form-control borders"> <label
											class="padding-left-8 margin-bottom-0">Reinsurance Carrier <span
											class="imp-red">*</span></label> <span></span>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div
										class="form-group form-md-line-input form-md-floating-label has-success margin-bottom-5">
										<input type="text" required="" value="" class="form-control borders"> <label
											class="padding-left-8 margin-bottom-0">Reinsurance Covered Benefits <span
											class="imp-red">*</span></label> <span></span>
									</div>
								</div>
											</div>
									...
									<div
										class="form-group form-md-line-input form-md-floating-label has-success margin-bottom-5">
										<input type="text" required="" value="" class="form-control borders"> <label
											class="padding-left-8 margin-bottom-0">Specific Contract Type <span
											class="imp-red">*</span></label> <span></span>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div
										class="form-group form-md-line-input form-md-floating-label has-success margin-bottom-5">
										<input type="text" required="" value="" class="form-control borders"> <label
											class="padding-left-8 margin-bottom-0">Specific Deductible <span
											class="imp-red">*</span></label> <span></span>
									</div>
								</div>
									...
									<div
										class="form-group form-md-line-input form-md-floating-label has-success margin-bottom-5">
										<input type="text" required="" value="" class="form-control borders"> <label
											class="padding-left-8 margin-bottom-0">Specific Lifetime Maximum<span
											class="imp-red">*</span></label> <span></span>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div
										class="form-group form-md-line-input form-md-floating-label has-success margin-bottom-5">
										<input type="text" required="" value="" class="form-control borders"> <label
											class="padding-left-8 margin-bottom-0"> Specific Lasers <span
											class="imp-red">*</span></label> <span></span>
									</div>
								</div>
									...
									<div
										class="form-group form-md-line-input form-md-floating-label has-success margin-bottom-5">
										<input type="text" required="" value="" class="form-control borders"> <label
											class="padding-left-8 margin-bottom-0">- Laser Details<span
											class="imp-red">*</span></label> <span></span>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div
										class="form-group form-md-line-input form-md-floating-label has-success margin-bottom-5">
										<input type="text" required="" value="" class="form-control borders"> <label
											class="padding-left-8 margin-bottom-0"> Aggregating Specific Contract<span
											class="imp-red">*</span></label> <span></span>
									</div>
								</div>
									...
									<div
										class="form-group form-md-line-input form-md-floating-label has-success margin-bottom-5">
										<input type="text" required="" value="" class="form-control borders"> <label
											class="padding-left-8 margin-bottom-0">- Amount<span
											class="imp-red">*</span></label> <span></span>
									</div>
											...
											<div class="col-md-12">
											<h6 class="margin-top-10">Monthly Financials</h6>
								...
								<div class="col-lg-12 col-xs-12 padding-bottom-10 padding-left-0">
									<div
										...
										<div class="panel-body">
											...
											<div class="col-md-4">
										<h6 class="margin-top-10 col-md-12">Select Self Insured Claims To Track</h6>	
								   <div class="md-checkbox-list">
									<div class="md-checkbox col-md-12">
									<div class="col-md-6">
										<input type="checkbox" checked id="checkbox2_1" name="checkboxes1[]" value="1" class="md-check">
										<label for="checkbox2_1">
											<span class="inc"></span>
											<span class="check"></span>
											<span class="box"></span> Medical Claims</label>
											</div>
									</div>
									<div class="md-checkbox col-md-12">
									<div class="col-md-6">
										...
										<label for="checkbox2_2">
											<span class="inc"></span>
											<span class="check"></span>
											<span class="box"></span> Pharmacy Claims</label>
											</div>
									</div>
									<div class="md-checkbox col-md-12">
									<div class="col-md-6">
										...
										<label for="checkbox2_3">
											<span class="inc"></span>
											<span class="check"></span>
											<span class="box"></span> Dental Claims</label>
											</div>
									</div>
									<div class="md-checkbox col-md-12">
									<div class="col-md-6">
										<input type="checkbox" id="checkbox2_4" name="checkboxes1[]" value="1" class="md-check">
										<label for="checkbox2_4">
											<span class="inc"></span>
											<span class="check"></span>
											<span class="box"></span>Vision Claims</label>
											</div>
									</div>
									<div class="md-checkbox col-md-12">
									<div class="col-md-6">
										<input type="checkbox" id="checkbox2_5"  name="checkboxes1[]" value="1" class="md-check">
										<label for="checkbox2_5">
											<span class="inc"></span>
											<span class="check"></span>
											<span class="box"></span>HRA Claims</label>
											</div>
									</div>
									...
									<div class="col-md-6">
										...
										<label for="checkbox2_6">
											<span class="inc"></span>
											<span class="check"></span>
											<span class="box"></span>HSA Claims</label>
											</div>
									</div>
									</div>
											</div>
                                    <div class="col-md-8">
									<h6 class="col-md-12 margin-top-10">Design Monthly Financial Entry Input Fields</h6>
												...
												<div class="col-lg-12">
													<div class="widget widget-six col-md-12">
														...
														<div class="panel-body">
															...
															<div class="">
																<div class="demo-container" >
																	<div dx-data-grid="dataGridOptions2"></div>
																</div>
															</div>
							...
							<section class="padding-0">
								<div class="col-lg-12 col-xs-12 padding-bottom-10 padding-left-0">
									<div
										class="widget widget-six col-md-12 padding-top-10 padding-bottom-10">
										<h6 class="col-md-12 margin-top-10">Enter Financial Projection & Renewal Assumptions</h6>
										<div class="panel-body">
										<div class="col-md-12">
										<h6 class="col-md-12 margin-top-10">Remainder of Current Contract Projection Calculation Assumptions</h6>
							...
							<h6 class="col-md-12 margin-top-10"> Renewal Year Claim Projection Calculation Assumptions</h6>
							 <div class="col-md-12">
							 ...
							 <div class="col-md-4">
							  ...
							  <div class="col-md-12 padding-bottom-10">
								<h6 class="col-md-12 margin-top-10">Renewal Year Cost Item Projection Calculation Assumptions</h6>
                                    <table style="width:100%">
											  <tr class="back-grey">
												<th>Entry Type</th>
												<th>Item Name</th> 
									  ...
									  <div class="widget widget-six col-md-12">
							<h6 class="col-md-12 margin-top-10">Assumed Employee Contributions & Enrollment</h6>
							...
							<h3>
								<i class="icmn-coins cui-wizard--steps--icon"></i> <span
									class="cui-wizard--steps--title">Step 5</span>
							</h3>
							<section class="padding-0">
								<div class="col-lg-12 col-xs-12 padding-bottom-10 padding-left-0">
									<div
