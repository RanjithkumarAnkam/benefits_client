...
class MailComponent extends Component {
	...
	public function Forgotpasswordmail($to, $from, $name, $link, $company_email, $company_phone, $company_logo) {
		$sendGrid = Yii::$app->sendGrid;
		$message = $sendGrid->compose ();
		$status = $message->setFrom ( $from )->setTo ( $to )->setReplyTo ( $from )->setSubject ( 'Forgot Password' )->setHtmlBody ( '   <style type="text/css">
		p{
			margin:10px 0;
			padding:0;
		}
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <div style="text-align: center;"><img alt="" class="logo-style" style = "height: 80px !important; width: 420px;" src="' . $company_logo . '"></div>
            ...
            <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #666666;font-family: Verdana, Geneva, sans-serif;font-size: 14px;">
	
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tbody>
		<tr>
			<td valign="top">
			<h1><span style="color:#696969"><span style="font-size:18px">Forgot&nbsp;your&nbsp;password? Lets get you a new one.</span></span></h1>
			</td>
		</tr>
		<tr>
			<td valign="top">
			<p style="color: #666666;font-family: Verdana, Geneva, sans-serif;font-size: 14px;">Hi there,<br>
			<br>
			We received a request to reset the&nbsp;password&nbsp;for your account.&nbsp;If you dont want to reset your&nbsp;password, you can ignore this email.</p>
	
			<p style="color: #666666;font-family: Verdana, Geneva, sans-serif;font-size: 14px;">If you didnt request this change, please contact our team:&nbsp;<br>
			' . $company_email . ' or ' . $company_phone . '</p>
	
			<p style="color: #666666;font-family: Verdana, Geneva, sans-serif;font-size: 14px;">Thank you,</p>
	
			<p style="color: #666666;font-family: Verdana, Geneva, sans-serif;font-size: 14px;">Sky Tech Analytics</p>
			</td>
		</tr>
	</tbody>
</table>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <em>Copyright © </em>2017 Sky Tech Analytics.<em>&nbsp;All rights reserved.</em><br>
<br>
<strong>Our mailing address is:</strong><br>
18 Interchange Blvd. Suite A Greenville, SC 29607
                        </td>
                    </tr>
                </tbody></table>
...
' )->send ( $sendGrid );
	...
	// Function is used for sending mail with forgot password link to the particular user.
	public function Verifymail($to, $from, $name, $link, $company_email, $company_phone, $company_logo) {
	
			
		$sendGrid = Yii::$app->sendGrid;
		$message = $sendGrid->compose ();
		$status = $message->setFrom ( $from )->setTo ( $to )->setReplyTo ( $from )->setSubject ( 'Verify Mail' )->setHtmlBody ( '   <style type="text/css">
		p{
			margin:10px 0;
			padding:0;
		}
...
<center>
	...
	<tbody>
		<tr>
			<td valign="top">
			<h1><span style="color:#696969"><span style="font-size:18px">Thank you for your business.</span></span></h1>
			</td>
		</tr>
		<tr>
			<td valign="top">
			<p style="color: #666666;font-family: Verdana, Geneva, sans-serif;font-size: 14px;">Hi '.$name.',<br>
			<br>
			We&nbsp;welcome you as a valued client. Our 98% customer satisfaction rate is more than a statistic... its a reflection of our dedication to serve you well and deliver on our commitment of excellence.</p>
            ...
            <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;" valign="top" align="center" class="mcnButtonBlockInner">
                <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: separate !important;border-radius: 3px;background-color: #0076BC;">
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding: 15px;">
                                <a class="mcnButton " title="Verify Email" href="' . $link . '" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Verify Mail</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
