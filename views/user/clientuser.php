...
<section class="page-content padding-0">
	<div class="page-content-inner">
		...
		<!-- Dashboard -->
			...
			<div class="">
			<div class="">
						<div class="col-md-12 alert-div p-0">
							<?php
                    ...
                    <div>
                        <ul class="nav nav-tabs mb-4 blue-main-nav" role="tablist">
                            ...
                            <li class="nav-item cursor-nodrop">
                                <a  class="nav-link color-white pointer-disable" id="anchor-pb-5" data-target="#profile5" data-toggle="tab" href="javascript: void(0);" role="tab" aria-expanded="false">Client Users 
													...
													<fieldset class="fieldset-box">
															...
															<div class="col-md-6">
																...
																<div class="form-group ">
																	<label class="form-control-label" for="l0">Client Name
																		*</label>
																	<?= $form->field($model, 'client_name', ['inputOptions' => ['class' => 'form-control']])->textInput(['maxlength' => true])->label(false); ?>
																</div>
														...
														<div class="col-md-12 padding-0">
															...
															<div class="col-md-6">
																...
																<?= $form->field($model, 'company_logo', ['inputOptions' => ['class' => 'form-control']])->fileInput(['accept'=>'image/x-png, image/jpeg'])->label ( false ); ?>
															</div>
													...
													<fieldset class="fieldset-box">
														...
														<div class="">
															<label class="form-control-label" for="l0">Logo to use in
																...
																data-toggle="popover-hover" data-placement="right"
																data-content="Select if you would like your firms logo to be used in the client claims reporting. Alternatively, you can choose to use the client’s logo.”"></i>
															</label>
															<div class="mt-radio-inline  padding-0">
																...
																<div class="col-md-12">
																	<div class="pull-left">
																		...
																		<button type="button" id="no_of_client_for_this_firm"
																			class="btn btn-primary cursor-default"><?php if(!empty($client_id)){ echo $client_count; } else {echo '#'; } ?></button>
																	</div>
																	<div class="pull-left margin-left-10">
																		<label class="margin-bottom-0 margin-right-2">$/Mo</label>
																		<button type="button" id="amount_of_client_package_for_this_firm"
																			class="btn btn-primary cursor-default"><?php if(!empty($client_active_modules)){ echo '$ '.$client_active_modules->amount; } ?></button>
																	</div>
																	<div>
																		<legend>
