...
<div class="modal fade" id="create_firm_user" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
						   ...
						   <div class="">
									...
									<div class="col-md-3 padding-right-0">
									 <label class="form-control-label" for="l0">Extn </label>
														...
														<div class="col-md-12 padding-0">
														<div class="col-md-9 padding-0">
														<input type="text" class="form-control us-phone-mask-input" value="">
														</div>
														<div class="col-md-3 padding-right-0">
