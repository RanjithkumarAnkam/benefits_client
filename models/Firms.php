...
class Firms extends \yii\db\ActiveRecord
{
    ...
    {
        return [
        		[['firm_name', 'address_1', 'city', 'billing_city', 'billing_state', 'state', 'zip', 'billing_zip', 'phone', 'created_by', 'created_date', 'firm_locations', 'billing_address_1'], 'required'],
        		[['state', 'zip', 'is_active', 'created_by', 'modified_by', 'billing_zip','billing_state'], 'integer'],
			...
			['address_2', 'match', 'pattern' => "/^[a-zA-Z0-9&,#. ]+$/", 'message' => 'Address 2 can only contain alpha, number, space, dot , comma, hash, ampersand .'],
        		...
        		['billing_address_2', 'match', 'pattern' => "/^[a-zA-Z0-9&,#. ]+$/", 'message' => 'Billing Address 2 can only contain alpha, number, space, dot , comma, hash, ampersand .'],
        		[['city', 'billing_city'], 'match', 'pattern' => '/^[a-zA-Z ]+$/', 'message' => 'City name can only contain alphabets.'],
        		[['zip','billing_zip'], 'string', 'min' => 5],
			[['website'], 'url'],
        		[['address_1', 'address_2', 'billing_address_1', 'billing_address_2'], 'string', 'max' => 200],
        		[['city', 'billing_city', 'website', 'firm_logo'], 'string', 'max' => 100],
