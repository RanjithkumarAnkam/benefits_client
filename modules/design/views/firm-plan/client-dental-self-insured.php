		...
		<div class="dashboard-container">
			...
			<div class="blue-breadcrumb col-md-12 padding-0">
				...
				<div class="breadcrumb-description">
					<span class="">Master Data &gt; <a class="color-white" href="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/design/firm-plan/client-plan-years?id=2"><u>Manage Plans - Group Dental - Prior (2016)</u></a> &gt; Partially Self Insured</span>
				...
				<div class="tab-pane active" id="account_setup_block">
					<div class="col-md-12  padding-10 ul-block">
						<ul class="nav nav-pills nav-wizard inner-block-ul">
							...
							<li href="#typestotrack" data-toggle="tab" class="inner-block-li" id="anchor-pb-3"><a><div class="inner-block-digits pull-left">2</div><span class="inner-block-text">Claim Types to Track</span></a></li>
							...
							<li href="#empcontribtion" data-toggle="tab" class="inner-block-li" id="anchor-pb-5"><a><div class="inner-block-digits pull-left">4</div><span class="inner-block-text">Emp Contributions &amp; Avg Enr</span></a></li>
						</ul>
					</div>
						...
						<div class="border-top-bottom-ddd col-md-12 padding-0">
							<div class="container margin-top-10 margin-bottom-10">
														<div class="col-md-4">
																		...
																		<div class="form-group ">
																			<label class="form-control-label" for="l0">Network<span class="imp-red"></span>
																			</label>
																			<input type="text" class="form-control placeholder-italics" value=""
															...
															<div class="col-md-4">
																<div class="form-group ">
																			...
																			<input
																				...
																				value="Partially Self Insured" placeholder="e.g. Partially Self Insured Insured (since this is partially self insured Dental)" disabled>
							...
							&nbsp;&nbsp;&nbsp;<a type="button" class="btn btn-default pull-right" href="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/design/firm-plan/client-plan-years?id=2">Cancel</a>
						...
						<div class="border-top-bottom-ddd col-md-12 padding-0">
							<div class="container margin-top-10 margin-bottom-10">
									...
									<!--		<div class="col-md-12 form-group">
												...
												<div class="col-md-6">
													<label><u>Adjustment to Impact Which Claim</u></label>
												</div>
											</div>

											<div class="col-md-12 form-group ">
												<div class="col-md-6">
													<label class="width-100">Claim Reimbursement</label>

												</div>
												<div class="col-md-6">
													<select class="form-control padding-bottom-5">
															<option value="1" selected>Dental Claims</option>
															<option value="2">HRA Claims</option>
														</select>
...
-->
									...
									<!--		<div class="col-md-12 form-group">
											...
											<div class="col-md-12 header-reimbursment">
												<div class="col-md-6">
													<label class="width-100">Administrative Fees</label> 
												</div>
						...
						<div class="border-top-bottom-ddd col-md-12 padding-0">
							...
							<div class="col-md-12 header-reimbursment">
												...
												<div class="col-md-12 padding-0">
													...
													<div class="col-md-6">
														<input class="form-control  placeholder-italics" placeholder="e.g. Basic Dental Plan"/>
													</div>
												</div>
