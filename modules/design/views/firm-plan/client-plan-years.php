...
<section class="page-content padding-0">
	...
	<div class="col-md-12 padding-0 widget pull-left width-100">
				...
				<span class=" margin-top-10" href="javascript:void(0);"> <img width="65"src="/images/design/firm_logo.png" alt="Alternative text to the image">
								...
								<a type="button" class="pull-right btn btn-modal-blue" href="<?php echo Yii::$app->getUrlManager()->getBaseUrl();?>/design/firm-plan/client-medical-self-insured#home2">Add / Update Financials</a>
								 </div>
							</div>
				...
				<span class=" margin-top-10" href="javascript:void(0);"> <img width="65"src="/images/design/firm_logo.png" alt="Alternative text to the image">
								...
								<div class="col-xs-12 border-ddd pd-botm-2 pd-top-2 bg-light-blue" style="font-family: arial;">
								<a type="button" class="pull-right btn btn-modal-blue" href="<?php echo Yii::$app->getUrlManager()->getBaseUrl();?>/design/firm-plan/client-medical-fully-insured#home2">Add / Update Financials</a>
				...
				<span class=" margin-top-10" href="javascript:void(0);"> <img width="65"src="/images/design/firm_logo.png" alt="Alternative text to the image">
								...
								<div class="col-xs-12 border-ddd pd-botm-2 pd-top-2 bg-light-blue" style="font-family: arial;">
								<a type="button" class="pull-right btn btn-modal-blue" href="<?php echo Yii::$app->getUrlManager()->getBaseUrl();?>/design/firm-plan/client-medical-level-funded#home2">Add / Update Financials</a>
				...
				<span class=" margin-top-10" href="javascript:void(0);"> <img width="65"src="/images/design/firm_logo.png" alt="Alternative text to the image">
								...
								<div class="col-xs-12 border-ddd pd-botm-2 pd-top-2 bg-light-blue" style="font-family: arial;">
								<a type="button" class="pull-right btn btn-modal-blue" href="<?php echo Yii::$app->getUrlManager()->getBaseUrl();?>/design/firm-plan/client-dental-self-insured#home2">Add / Update Financials</a>
								 </div>
							</div>
				...
				<span class=" margin-top-10" href="javascript:void(0);"> <img width="65"src="/images/design/firm_logo.png" alt="Alternative text to the image">
								...
								<div class="col-xs-12 border-ddd pd-botm-2 pd-top-2 bg-light-blue" style="font-family: arial;">
								<a type="button" class="pull-right btn btn-modal-blue" href="<?php echo Yii::$app->getUrlManager()->getBaseUrl();?>/design/firm-plan/client-dental-fully-insured#home2">Add / Update Financials</a>
								 </div>
							</div>
							 <?php }?>
				...
				<span class=" margin-top-10" href="javascript:void(0);"> <img width="65"src="/images/design/firm_logo.png" alt="Alternative text to the image">
								...
								<div class="col-xs-12 border-ddd pd-botm-2 pd-top-2 bg-light-blue" style="font-family: arial;">
								<a type="button" class="pull-right btn btn-modal-blue" href="<?php echo Yii::$app->getUrlManager()->getBaseUrl();?>/design/firm-plan/client-vision-self-insured#home2">Add / Update Financials</a>
				...
				<span class=" margin-top-10" href="javascript:void(0);"> <img width="65"src="/images/design/firm_logo.png" alt="Alternative text to the image">
								...
								<div class="col-xs-12 border-ddd pd-botm-2 pd-top-2 bg-light-blue" style="font-family: arial;">
								<a type="button" class="pull-right btn btn-modal-blue" href="<?php echo Yii::$app->getUrlManager()->getBaseUrl();?>/design/firm-plan/client-vision-fully-insured#home2">Add / Update Financials</a>
        ...
        'error':   'Ooops, something wrong happended.'
            ...
            $('#toggleDropify').on('click', function(e){
			  ...
			  function planDetails(){
				...
				window.location = "<?php echo Yii::$app->getUrlManager()->getBaseUrl();?>/design/firm-plan/client-plan-years?id="+ id;
			  }
				</script>
