		...
		<div class="dashboard-container">
			...
			<div class="blue-breadcrumb col-md-12 padding-0">
				...
				<div class="breadcrumb-description">
					<span class="">Master Data &gt; <a class="color-white" href="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/firm-plan/client-plan-years?id=2"><u>Manage Plans - Group Dental - Prior (2016)</u></a> &gt; Fully Insured</span>
				...
				<div class="tab-pane active" id="account_setup_block">
					...
					<div class="tab-content clearfix">
														...
														<div class="col-md-4">
																		...
																		<div class="form-group ">
																			<label class="form-control-label" for="l0">Name of
																				the Plan<i class="fa fa-info-circle margin-left-5" title="Name of the Plan" data-container="body" data-toggle="popover-hover" data-placement="right" data-content="Name the plan in a way you would normally talk about the plan, such as Group PPO Plan"></i></label></label>
																		...
																		<div class="form-group ">
																			<label class="form-control-label" for="l0">Annual
																				Fee/Commission on Plan
																				 <i class="fa fa-info-circle margin-left-5"  data-container="body" data-toggle="popover-hover" data-placement="right" data-content="Enter in the total amount of commissions and other consulting fees your firm will receive on this plan for the plan year." data-original-title="Annual Fee/Commission on Plan"></i>
																				 <span class="imp-red">*</span>
																			</label>
															...
															<div class="col-md-4">
																<div class="form-group ">
																			...
																			<i class="fa fa-info-circle margin-left-5"  data-container="body" data-toggle="popover-hover" data-placement="right" data-content="Choose the plan funding for this plan as partially self insured, self insured, fully insured or level funded" data-original-title="Plan Funding"></i>
																			</label>
																			<input
																				type="text" class="form-control placeholder-italics"
																				value="Dental Fully Insured" disabled>
						...
						<div class="border-top-bottom-ddd col-md-12 padding-0">
												...
												<div class="col-md-6 padding-0">
													...
													<div class="col-md-5">
														...
														<div class="col-md-12 padding-top-10">
														    ...
														    <table class="table table-hover table-backcolor" id="editable_contributions_track_dental">
                            <thead>
                                <tr>
                                   
                                    <th class="no-wrap" id="contributiondental-column-1">Tier No.</th>
                                     <th class="no-wrap" id="contributiondental-column-2">Tier Name</th>
									 <th class="no-wrap" id="contributiondental-column-3">Monthly Rates</th>
									 <th class="no-wrap" id="contributiondental-column-4">Monthly Enrollment</th>
									  <th class="no-wrap" id="contributiondental-column-5">Add Row</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td id="contributiondental-left-header-1">Tier 1</td>
									 <td><select class="form-control reinsurance-rates-td" id="contributiondental-2-1" class="form-control reinsurance-rates-td text-align-right">
								 <option>Employee</option>
								 <option>Employee + Spouse</option>
								 <option>Employee + Child</option>
								 <option>Employee + Child(ren)</option>
								  ...
								  <option>Employee + 1</option>
								   <option>Employee + 2</option>
								    <option>Employee + 3</option>
									  ...
									  <td><input type="text" id="contributiondental-3-1" class="form-control reinsurance-rates-td text-align-right" value="99.00"></td>
									   <td><input type="text" id="contributiondental-4-1" class="form-control reinsurance-rates-td text-align-right" value="$68.00"></td>
									    <td></td>
									<td></td>
                                  </tr>
                                 
                                  <tr>
                                    <td id="contributiondental-left-header-2">Tier 2</td>
									 <td><select class="form-control reinsurance-rates-td" id="contributiondental-2-2" class="form-control reinsurance-rates-td text-align-right">
								 <option>Employee</option>
								 <option>Employee + Spouse</option>
								 <option>Employee + Child</option>
								 <option>Employee + Child(ren)</option>
								  ...
								  <option>Employee + 1</option>
								   <option>Employee + 2</option>
								    <option>Employee + 3</option>
									   ...
									   <td><input type="text" id="contributiondental-3-2" class="form-control reinsurance-rates-td text-align-right" value="99.00"></td>
									   <td><input type="text" id="contributiondental-4-2" class="form-control reinsurance-rates-td text-align-right" value="$68.00"></td>
									<td class="add_contributiondental_button"><div class="add-icon"><span class="button-add" onclick="addEmployeecontributiondental();">+</span></div></td>
                                  </tr>
                            </tbody>
                        </table>
						 	</div>
						   ...
						   <table class="table table-hover table-backcolor" id="editable_contributions_track_two_dental">
                            <thead>
                                <tr>
                                   
                                    <th class="no-wrap" id="contributiondentaltwo-column-1">Tier No.</th>
                                     <th class="no-wrap" id="contributiondentaltwo-column-2">Tier Name</th>
									 <th class="no-wrap" id="contributiondentaltwo-column-3">Monthly Rates</th>
									 <th class="no-wrap" id="contributiondentaltwo-column-4">Monthly Enrollment</th>
									  <th class="no-wrap" id="contributiondentaltwo-column-5">Add Row</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td id="contributiondentaltwo-left-header-1">Tier 1</td>
									 <td><select class="form-control reinsurance-rates-td" id="contributiondentaltwo-2-1" class="form-control reinsurance-rates-td text-align-right">
								 <option>Employee</option>
								 <option>Employee + Spouse</option>
								 <option>Employee + Child</option>
								 <option>Employee + Child(ren)</option>
								  ...
								  <option>Employee + 1</option>
								   <option>Employee + 2</option>
								    <option>Employee + 3</option>
									  ...
									  <td><input type="text" id="contributiondentaltwo-3-1" class="form-control reinsurance-rates-td text-align-right" value="99.00"></td>
									   <td><input type="text" id="contributiondentaltwo-4-1" class="form-control reinsurance-rates-td text-align-right" value="$68.00"></td>
									    <td></td>
									<td></td>
                                  </tr>
                                 
                                  <tr>
                                    <td id="contributiondentaltwo-left-header-2">Tier 2</td>
									 <td><select class="form-control reinsurance-rates-td" id="contributiondentaltwo-2-2" class="form-control reinsurance-rates-td text-align-right">
								 <option>Employee</option>
								 <option>Employee + Spouse</option>
								 <option>Employee + Child</option>
								 <option>Employee + Child(ren)</option>
								  ...
								  <option>Employee + 1</option>
								   <option>Employee + 2</option>
								    <option>Employee + 3</option>
									   ...
									   <td><input type="text" id="contributiondentaltwo-3-2" class="form-control reinsurance-rates-td text-align-right" value="99.00"></td>
									   <td><input type="text" id="contributiondentaltwo-4-2" class="form-control reinsurance-rates-td text-align-right" value="$68.00"></td>
				...
				<div class="tab-pane" id="cost_projections_block">
					<div class="col-md-12  padding-10 ul-block">
						<ul class="nav nav-pills nav-wizard">
							<li href="#claims_project_assumption" data-toggle="tab" class="inner-block-li active" id="anchor-pb-7"><a><div class="inner-block-digits pull-left">1</div><span class="inner-block-text">Renewal Projections</span></a></li>
                                ...
                                <tr>
								   ...
								   <tr class="header-td back-gray">
									  ...
									  <td id="inputfinance-left-header-4">Gross Total</td>
									   <td id="inputfinance-2-4"  >$200</td>
									    <td id="inputfinance-3-4"  >$200</td>
										<td id="inputfinance-4-4"  >$200</td>
									    <td id="inputfinance-5-4"  >$200</td>
										<td id="inputfinance-6-4"  >$200</td>
									    <td id="inputfinance-7-4" >$200</td>
										<td id="inputfinance-8-4" >$200</td>
									    <td id="inputfinance-9-4"  >$200</td>
										<td id="inputfinance-10-4" >$200</td>
									    <td id="inputfinance-11-4"  >$200</td>
										<td id="inputfinance-12-4" >$200</td>
									     <td id="inputfinance-13-4" >$200</td>
                                  </tr>
								 
							
							<tr>
                                  
									  <td id="inputfinance-left-header-5">Employee Contribution</td>
								  ...
								  <tr>
									  ...
									  <td id="inputfinance-left-header-6">Cobra Premium</td>
								  ...
								  <tr>
									  ...
									  <td id="inputfinance-left-header-7">Member Copays, Coinsurance and Deductibles</td>
                              ...
                              <tr class="header-td back-gray">
                               ...
                               <td class="column-1 column-td"  id="inputfinance-2-8" >$110</td>
                                <td class="column-2 column-td"  id="inputfinance-3-8" >$50</td>
                                <td class="column-3 column-td"  id="inputfinance-4-8" >$250</td>
                                <td class="column-4 column-td"  id="inputfinance-5-8" >$250</td>
                                <td class="column-5 column-td"  id="inputfinance-6-8" >$250</td>
                                <td class="column-6 column-td"  id="inputfinance-7-8" >$80</td>
                                <td class="column-7 column-td"  id="inputfinance-8-8" >$80</td>
                                <td class="column-8 column-td"  id="inputfinance-9-8" >$225</td>
                                <td class="column-9 column-td"  id="inputfinance-10-8" >$110</td>
                                <td class="column-10 column-td"  id="inputfinance-11-8" >$222</td>
                                <td class="column-11 column-td"  id="inputfinance-12-8" >$222</td>
                                <td class="column-12 column-td"  id="inputfinance-13-8" >$222</td>
                            </tr>
                            </tbody>
                        </table>
