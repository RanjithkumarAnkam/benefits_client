		...
		<div class="dashboard-container">
			...
			<div class="row container" ng-app="DemoApp"
						...
						<ul class="nav nav-tabs  main-tabs" role="tablist">
							<li class="nav-item col-md-3 div-element "><a id="main-anchor-1"
								...
								href="#home2" role="tab"> <span class="number">1.</span><span
									class="desc"> <label>Create Firm</label>
								</span>
				...
				<div class="action-coloumn">
												<a id="modal-alert" href="#alert_screen" data-toggle="modal">Deactivate
													Company & Company Users</a>
											</div>
				<?php } ?>
				 <div class="row">
												<div class="col-md-6">
													...
													<div class="md-checkbox-list">
														<label class="mt-checkbox mt-checkbox-outline"> Plan
															Claims Reporting <input type="checkbox" value="1" name="">
															<span></span>
														</label>
						...
						<?php   }?>
														...
														<div class="col-md-6 padding-0">
															<div class="">
																<div class="">
																	<label class="mt-checkbox mt-checkbox-outline"> Same as
																		primary contact information <input type="checkbox"
									...
									<div class="nav-tabs-horizontal">
										...
										<ul class="nav nav-tabs mb-4" role="tablist">
											<li class="nav-item col-md-3 padding-0 margin-0"><a
												...
												role="tab"><span class="number-left">1.</span> Firm User Details</a></li>
											<li class="nav-item col-md-3 padding-0  margin-0"><a
												...
												role="tab"><span class="number-left">2.</span>Firm User Access & Settings</a></li>
                                    ...
                                    <input type="text" class="form-control" placeholder="cellular">
										...
										<div class="tab-pane" id="claims_project_assumption"
											...
											<fieldset>
												...
												<div id="firm_user_actions" class="">
				...
				<div class="col-md-3 padding-0">
														<div class="md-checkbox-list margin-bottom-50">
															...
															<label class="mt-checkbox mt-checkbox-outline">
																...
																View Protected Health Info <input type="checkbox"
																value="1" name=""> <span></span>
															</label> <label class="mt-checkbox mt-checkbox-outline">
																Add New Clients <input type="checkbox" value="1" name="">
																<span></span>
															</label>
														...
														<div class="md-checkbox-list margin-bottom-50">
															...
															<label class="mt-checkbox mt-checkbox-outline"> Only My
																Locations <input type="checkbox" value="1" name=""> <span></span>
															</label> <label class="mt-checkbox mt-checkbox-outline">
																All Firm Locations <input type="checkbox" value="1"
																name=""> <span></span>
															</label>
													...
													<div class="col-md-3">
														<div class="md-checkbox-list margin-bottom-50">
															...
															<label class="mt-checkbox mt-checkbox-outline"> Only My
																Clients <input type="checkbox" value="1" name=""> <span></span>
															</label> <label class="mt-checkbox mt-checkbox-outline">
																Only My Locations Clients <input type="checkbox"
																value="1" name=""> <span></span>
															</label> <label class="mt-checkbox mt-checkbox-outline">
																All Firm Location Clients <input type="checkbox"
																value="1" name=""> <span></span>
															</label>
														...
														<div class="md-checkbox-list margin-bottom-50">
															...
															<label class="mt-checkbox mt-checkbox-outline"> Primary
																Firm Contact <input type="checkbox" value="1" name=""> <span></span>
															</label> <label class="mt-checkbox mt-checkbox-outline">
																Billing Firm Contact <input type="checkbox" value="1"
																name=""> <span></span>
															</label>
