		...
		<div class="dashboard-container">
			...
			<div class="blue-breadcrumb col-md-12 padding-0">
				...
				<div class="breadcrumb-description">
					<span class="">Master Data &gt; <a class="color-white" href="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/design/firm-plan/client-plan-years?id=3"><u>Manage Plans - Group Vision - Prior (2016)</u></a> &gt; Partially Self Insured</span>
				...
				<div class="tab-pane active" id="account_setup_block">
					<div class="col-md-12  padding-10 ul-block">
						<ul class="nav nav-pills nav-wizard inner-block-ul">
							...
							<li href="#typestotrack" data-toggle="tab" class="inner-block-li" id="anchor-pb-2"><a><div class="inner-block-digits pull-left">2</div><span class="inner-block-text">Claim Types to Track</span></a></li>
							...
							<li href="#empcontribtion" data-toggle="tab" class="inner-block-li" id="anchor-pb-4"><a><div class="inner-block-digits pull-left">4</div><span class="inner-block-text">Emp Contributions &amp; Avg Enr</span></a></li>
						</ul>
					</div>
					...
					<div class="tab-content clearfix">
														...
														<div class="col-md-4">
																		...
																		<div class="form-group ">
																			...
																			<input type="text" class="form-control placeholder-italics" value=""
																				placeholder="e.g. Group PPO Plan">
																		</div>
															...
															<div class="col-md-4">
																<div class="form-group ">
																			...
																			<input
																				...
																				value="Partially Self Insured" placeholder="e.g. Partially Self Insured Insured (since this is partially self insured medical)" disabled>
						...
						<div class="border-top-bottom-ddd col-md-12 padding-0">
							<div class="container margin-top-10 margin-bottom-10">
											...
											<div class="col-md-12">
												<div class="col-md-6">
													<label class="font-2rem"># of Claim Reimbursement Adjustments to Track</label>
												</div>
												<div class="col-md-6">
										...
										<div class="col-md-12   padding-bottom-10">
													<div class="">
														<div class="demo-container">
															<div dx-data-grid="dataGridOptionsreimbursement"></div>
														</div>
													</div>
												</div>
											...
											<div class="col-md-12">
												<div class="col-md-6">
													<label class="font-2rem"># of Additional Cost Items to
														Track</label>
												</div>
												<div class="col-md-6">
													<select class="form-control">
											   ...
											   <div class="col-md-12   padding-bottom-10">
													<div class="">
														<div class="demo-container">
															<div dx-data-grid="dataGridOptionsreimbursement2"></div>
														</div>
													</div>
												</div>
						...
						<div class="border-top-bottom-ddd col-md-12 padding-0">
							...
							<div class="col-md-12 header-reimbursment">
												...
												<div class="col-md-12 padding-0">
													...
													<div class="col-md-6">
														<input class="form-control  placeholder-italics" placeholder="e.g. Basic Vision Plan"/>
													</div>
												</div>
				...
				<div class="tab-pane" id="cost_projections_block">
					<div class="col-md-12  padding-10 ul-block">
						<ul class="nav nav-pills nav-wizard">
							<li href="#year_project_assumption" data-toggle="tab" class="active inner-block-li" id="anchor-pb-5"><a><div class="inner-block-digits pull-left">1</div><span class="inner-block-text" title="Remainder of Year Claim Projection Assumptions">Remainder of Year Claim...</span></a></li>
							<li href="#claims_project_assumption" data-toggle="tab" class="inner-block-li" id="anchor-pb-6"><a><div class="inner-block-digits pull-left">2</div><span class="inner-block-text">Renewal Claims Projection Assumptions</span></a></li>
							<li href="#cost_project_assumption" data-toggle="tab" class="inner-block-li" id="anchor-pb-7"><a><div class="inner-block-digits pull-left">3</div><span class="inner-block-text" title="Renewal Cost Item Renewal Assumptions">Renewal Cost Item Renewal...</span></a></li>
							<li href="#contribution_project_assumption" data-toggle="tab" class="inner-block-li" id="anchor-pb-8"><a><div class="inner-block-digits pull-left">4</div><span class="inner-block-text" title="Renewal Employee Contribution & Average Enrollment Assumption">Renewal Employee Contribution...</span></a></li>
						</ul>
					</div>
						...
						<div class="border-top-bottom-ddd col-md-12 padding-0">
							<div class="container margin-top-10 margin-bottom-10">
															...
															<div class="col-md-12 padding-0">
																...
																<div class="col-md-6 padding-0">
																	<label>HRA Claims</label>
																	<div class="">
																		<div class="demo-container">
																			<div dx-data-grid="dataGridOptions5"></div>
																		</div>
																	</div>
																</div>
															</div>
							...
							<div class="container margin-top-10 margin-bottom-10">
															...
															<div class="col-md-12 padding-0">
																<div class="col-md-6 padding-0">
																	...
																	<div class="">
																		<div class="demo-container">
																			<div dx-data-grid="dataGridOptions10"></div>
																		</div>
																	</div>
																</div>
																<div class="col-md-6 padding-0">
																	...
																	<div class="">
																		<div class="demo-container">
																			<div dx-data-grid="dataGridOptions11"></div>
																		</div>
																	</div>
																</div>
															</div>
					...
					<div class="tab-content clearfix">
						...
						<div class="border-top-bottom-ddd col-md-12 padding-0">
                            ...
                            <tr>
                              ...
                              <tr>
                               <td class="header-td">HRA Claims</td>
                               <td class="column-1 column-td" id="1">$200</td>
                                <td class="column-2 column-td" id="2">$50</td>
                                <td class="column-3 column-td" id="3">$250</td>
                                <td class="column-4 column-td" id="4">$250</td>
                              ...
                              <tr>
                               <td class="header-td">Claim Reimbursement</td>
                               <td class="column-1 column-td" id="1">$200</td>
                                <td class="column-2 column-td" id="2">$50</td>
                                <td class="column-3 column-td" id="3">$250</td>
                                <td class="column-4 column-td" id="4">$250</td>
                             ...
                             <tr>
                               <td class="header-td">Adminstrative Fees</td>
                               <td class="column-1 column-td" id="1">$200</td>
                                <td class="column-2 column-td" id="2">$50</td>
                                <td class="column-3 column-td" id="3">$250</td>
                                <td class="column-4 column-td" id="4">$250</td>
			  ...
			  <div class="col-md-12">
					 ...
					 <div class="col-md-12">
						  <div class="col-md-6 ">
							...
							<a type="submit" href="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/design/firm-plan/client-vision-self-insured"  class="btn  btn-modal-blue">
								Save
							</a>
						</div>
						</div>
