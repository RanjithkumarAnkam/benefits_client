...
<body class="theme-default body-blue colorful-enabled" id="body_color">
    <?php $this->beginBody()?>
...
<div class="modal fade" id="modal-firm-list" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
			...
			<div class="modal fade" id="billing-contact" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
				...
				<div class="modal fade" id="alert_screen" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false" style="z-index: 9999 !important;">
				...
				<div class="modal-dialog modal-sm">
					<div class="modal-content">
						...
						<div class="modal-body">
					<p>Do You Want to Deactivate the Firm ?</p>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content col-md-12 padding-0">
			<div class="modal-header modal-header-color">
				...
				<h4 class="modal-title color-white" id="myModalLabel">Create Firm
					User</h4>
			</div>
			<form id="form_create_firm_user" action="/self_insured/user/createfirmuser" onsubmit="return false;" enctype="multipart/form-data">
				<div class="modal-body col-md-12">
					...
					<input type="hidden" id="firm_user_for_firm" name="SupportVariable[firm_user_id]"
						value="<?php if(isset($_GET['id']) && $_GET['id']!=''){echo $_GET['id'];}?>" />
							...
							<div class="">
								<div class="form-group ">
									...
									<input type="text" class="form-control" value="" placeholder=""
										name="FirmUser[first_name]" id="first_name">
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="">
								<div class="form-group ">
									...
									<input type="text" class="form-control" value="" placeholder=""
										name="FirmUser[last_name]" id="last_name">
								</div>
							</div>
						...
						<div class="col-md-6">
							<div class="">
								<div class=" form-group">
									...
									<input type="text" class="form-control" value="" placeholder=""
										name="FirmUser[title]" id="job_title">
								</div>
							</div>
							...
							<div class="">
								<div class=" form-group ">
									...
									<select class="form-control height-120 select2 locations"
										name="FirmUser[locations]" id="locations" multiple>
							...
							<div class="">
								<div class="form-group">
									<label class="form-control-label" for="l0">Email Id*</label> <input
										...
										name="FirmUser[email_id]" id="email_id">
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="">
								...
								<div class="form-group col-md-12 padding-0">
									...
									<div class="col-md-12 padding-0">
										<div class="col-md-9 padding-0">
											<input type="text" class="form-control us-phone-mask-input"
												name="FirmUser[phone]" id="phone" value="">
										</div>
										<div class="col-md-3 padding-right-0">
											<input type="text" class="form-control" placeholder=""
												name="FirmUser[extension]" id="extension" value="">
										</div>
									</div>
								</div>
							...
							<div class="">
								<div class="form-group">
									<label class="form-control-label" for="l0">Mobile</label> <input
										type="text" class="form-control us-phone-mask-input" value=""
										name="FirmUser[cellular]" id="mobile" placeholder="">
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="">
								<div class="form-group ">
									...
									<input type="file" class="form-control us-phone-mask-input"
										name="FirmUser[profile_pic]" id="profile_image">
								</div>
							</div>
						</div>
					</div>
									...
									<div class="col-md-12 padding-0">
										<div class="col-md-9 padding-0">
											<label
												...
												<input type="hidden" value="0" name="FirmUser[is_primary]"/>
												<input type="checkbox" value="1" name="FirmUser[is_primary]"
												> <span></span>
											</label>
										</div>
										...
										<div class="col-md-9 padding-0">
											<label
												...
												<input type="hidden" value="0" name="FirmUser[is_billing]"/>
												<input type="checkbox" value="1"
												name="FirmUser[is_billing]"> <span></span>
											</label>
										</div>
									</div>
								</div>
									...
									<div class="md-checkbox-list">
										<div class="">
											<label
												...
												name="administrator_access"> <span></span>
											</label>
										</div>
				...
				<div class="modal-footer footer-background col-md-12">
					<button type="submit" class="btn btn-modal-blue" onclick="saveFirmUser();">Save</button>
...
<div class="modal fade" id="update_firm_user" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
				<div class="modal-dialog modal-lg">
					<div class="modal-content col-md-12 padding-0">
						<div class="modal-header modal-header-color">
											...
											<div class="col-md-6">
											  <div class="">
													<div class="form-group ">
														...
														<input type="text" class="form-control" value="teja"
  ...
  <div class="col-md-12 padding-0">
						   ...
						   <div class="">
													<div class="form-group">
														...
														<input type="text" class="form-control" value="manager@gmail.com"
 ...
 <h6 class="action_head">Set This User As:</h6>
						 <div class="col-md-12 padding-0">
						   <div class="col-md-9 padding-0">
                           <label class="mt-checkbox mt-checkbox-outline margin-bottom-10">     Firm Primary Contact
                           ...
                           <div class="col-md-9 padding-0">
                           <label class="mt-checkbox mt-checkbox-outline margin-bottom-10">    Firm Billing Contact
										<input type="checkbox" value="1" name="">
										<span></span>
									</label> 
                           </div>
										  ...
										  <div class="col-md-5">
										  <div class="">
													<h6 class="action_head">Access Privileges:</h6>
													...
													<div class="md-checkbox-list">
														...
														<div class="action_head "><b>View / Edit Clients:</b></div><div class="col-md-6 padding-0">
															<label class="mt-checkbox mt-checkbox-outline  margin-bottom-10"> My
																Locations <input type="checkbox" value="1"> <span></span>
															</label>
														
														
															<label class="mt-checkbox mt-checkbox-outline  margin-bottom-10"> All Firm
...
<p><a id="modal-alert" href="#alert_screen" class="color-blue"
														data-toggle="modal"><u>Deactivate User</u></a></p>
														<p><a id="modal-alert" href="#reset_password" class="color-blue"
				...
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						...
						<div class="modal-body row">
						 ...
						 <div class="col-md-6">
									...
									<div class="col-md-3 padding-right-0">
									 <label class="form-control-label" for="l0">Extn </label>
										...
										<div class="col-md-12 padding-0">
														...
														<div class="col-md-3 padding-right-0">
														<input type="text" class="form-control" placeholder="ext" value="">
														</div>
														</div>
														</div>
									</div>
						  ...
						  <div class="col-md-6">
							...
							<div class="">
                                ...
                                <input type="text" class="form-control us-phone-mask-input" placeholder="Mobile #" value="" >
                                </div>
                            </div>
						 </div>
						 </div>
						 ...
						 <div class="">
						   <div class="col-md-9 padding-0">
                           <label class="mt-checkbox mt-checkbox-outline margin-bottom-10">     Client Primary Contact
										<input type="checkbox" value="1" name="">
										<span></span>
									</label> 
                           </div>
                           ...
                           <div class="col-md-9 padding-0">
                           <label class="mt-checkbox mt-checkbox-outline margin-bottom-10">    Client Billing Contact
										<input type="checkbox" value="1" name="">
										<span></span>
									</label> 
                           </div>
						...
						<div class="modal-body row">
						 ...
						 <div class="col-md-6">
						   <div class="">
                             ...
                             <input type="text" class="form-control" placeholder="First Name" value="praveen">
                                </div>
                            </div>
						 </div>
						  <div class="col-md-6">
						  <div class="">
                                ...
                                <input type="text" class="form-control" placeholder="Last Name" value="singh">
                                </div>
                            </div>
						 </div>
						 </div>
						 ...
						 <div class="">
                                ...
                                <input type="text" class="form-control" placeholder="Job Title" value="manager">
                                </div>
                            </div>
						 </div>
						  <div class="col-md-6">
						   <div class="">
                                ...
                                <input type="text" class="form-control" placeholder="Email Id" value="manager@gmail.com">
                                </div>
                            </div>
						 </div>
						 </div>
						 ...
						 <div class="col-md-6">
						  ...
						  <div class="col-md-6">
							...
							<div class="">
                                ...
                                <input type="text" class="form-control us-phone-mask-input" placeholder="Mobile #" value="9999999999" >
                                </div>
                            </div>
						 </div>
						 </div>
						  ...
						  <div class="col-md-6">
									 <h6 class="action_head">Access Privileges:</h6>				
													...
													<div class="md-checkbox-list ">
															...
															<label class="mt-checkbox mt-checkbox-outline margin-bottom-10 width-100">
																Super Admin <input type="checkbox" value="1" checked
																name=""> <span></span>
															</label>
															<label class="mt-checkbox mt-checkbox-outline margin-bottom-10 width-100">
																View Dashboard Financials <input type="checkbox" value="1" checked
																name=""> <span></span>
															</label>
...
<p><a id="modal-alert" href="#alert_screen" class="color-blue"
														...
														<div class="col-md-12 ">
														 ...
														 <h6 class="action_head">Admin Access</h6>
														 <div class="md-checkbox-list">
				 
														<label class="mt-checkbox mt-checkbox-outline no-wrap margin-bottom-10">Add / Edit Admin Users
                                                            <input type="checkbox" value="1" name="checkbox2">
                                                            <span></span>
                                                        </label>
														<label class="mt-checkbox mt-checkbox-outline display-block no-wrap margin-bottom-10"> System Pricing
                                                            <input type="checkbox" value="2" name="checkbox2">
                                                            <span></span>
                                                        </label>
														<label class="mt-checkbox mt-checkbox-outline display-block no-wrap margin-bottom-10">System Billing
                                                            <input type="checkbox" value="3" name="checkbox2">
                                                            <span></span>
                                                        </label>
														<label class="mt-checkbox mt-checkbox-outline no-wrap margin-bottom-10">Firm Pricing
...
<h6 class="action_head">Firm Access</h6>									
 <div class="md-checkbox-list ">							
													...
													<label class="mt-checkbox mt-checkbox-outline no-wrap margin-bottom-10"> Add / Edit Firm 
                                                            <input type="checkbox" value="1" name="checkbox3">
                                                            <span></span>
                                                        </label> 
													
 
													<label class="mt-checkbox mt-checkbox-outline no-wrap  margin-bottom-10"> Add / Edit Firm Users
												...
												<h6 class="action_head">Client Access</h6>
												 ...
												 <label class="mt-checkbox mt-checkbox-outline no-wrap  margin-bottom-10"> Add / Edit Client
                                                            <input type="checkbox" value="1" name="checkbox5">
                                                            <span></span>
                                                        </label> 
													   
                                                   <label class="mt-checkbox mt-checkbox-outline no-wrap  margin-bottom-10"> Add / Edit Client Users
...
//'mergeHeader'=>false,
    ...
    $('.view').click(function(e){
       e.preventDefault();
		$('#pModal').modal('show').find('.modal-content').addClass('col-md-12 padding-0');
        ...
        window.addEventListener('scroll', function(e){
            ...
            if (distanceY > shrinkOn) {
                ...
                if (classie.has(header,"smaller")) {
				 ...
				 if (classie.has(imgsize,"width-112")) {
                    classie.remove(imgsize,"width-112");
                }
  ...
  $.ajax({
	...
	success:function(data){
		...
		if (data['fail']) {
			...
			count = data['fail'].length;
			for($i=0;$i<count;$i++)
			{
				var data_array = data['fail'][$i];
				if(data_array != '')
				{
