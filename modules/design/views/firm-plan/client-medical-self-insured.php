		...
		<div class="dashboard-container">
			...
			<div class="blue-breadcrumb col-md-12 padding-0">
				...
				<div class="breadcrumb-description">
					<span class="">Master Data &gt; <a class="color-white" href="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/design/firm-plan/client-plan-years?id=1"><u>Manage Plans - Group Medical - Prior (2016)</u></a> &gt; Partially Self Insured</span>
							...
							<div class="col-md-12 padding-0 bg-sky-blue " align="right" style="border-top:none;">
								...
								<div class="modal-footer-btn padding-15">
								 ...
								 <button type="button" class="btn btn-modal-blue" disabled onclick="previousButton(0);">&lt; Previous</button>
								  ...
								  &nbsp;&nbsp;&nbsp;<a type="button" class="btn btn-default pull-right" href="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/design/firm-plan/client-plan-years?id=1">Cancel</a>
						...
						<div class="border-top-bottom-ddd col-md-12 padding-0">
                          ...
                          <div class="col-md-12   padding-bottom-10">
									...
									<!--		<div class="col-md-12 form-group">
												<div class="col-md-6">
													<label class="width-100"><u>Item Name</u></label>
												</div>
											</div>

											<div class="col-md-12 header-reimbursment">
												<div class="col-md-6">
													<label class="width-100">Administrative Fees</label> <label
														class="width-100">Stop Loss Premiums</label> <label
														class="width-100">Wellness Credit</label>
												</div>
				...
				<div class="tab-pane" id="cost_projections_block">
					<div class="col-md-12  padding-10 ul-block">
						<ul class="nav nav-pills nav-wizard">
							...
							<li href="#claims_project_assumption" data-toggle="tab" class="inner-block-li" id="anchor-pb-7"><a><div class="inner-block-digits pull-left">2</div><span class="inner-block-text">Renewal Claims Projection Assumptions</span></a></li>
							<li href="#cost_project_assumption" data-toggle="tab" class="inner-block-li" id="anchor-pb-8"><a><div class="inner-block-digits pull-left">3</div><span class="inner-block-text" title="Renewal Cost Item Renewal Assumptions">Renewal Cost Item Renewal...</span></a></li>
							<li href="#contribution_project_assumption" data-toggle="tab" class="inner-block-li" id="anchor-pb-9"><a><div class="inner-block-digits pull-left">4</div><span class="inner-block-text" title="Renewal Employee Contribution & Average Enrollment Assumption">Renewal Employee Contribution...</span></a></li>
						</ul>
					</div>
							...
							<div class="container margin-top-10 margin-bottom-10">
															...
															<div class="col-md-12 padding-0">
																<div class="col-md-6 padding-0">
																	...
																	<div class="">
																		<div class="demo-container">
																			<div dx-data-grid="dataGridOptions6"></div>
																		</div>
																	</div>
																</div>
																<div class="col-md-6 padding-0">
																	...
																	<div class="">
																		<div class="demo-container">
																			<div dx-data-grid="dataGridOptions7"></div>
																		</div>
																	</div>
																</div>
															</div>
															...
															<div class="col-md-12 padding-0">
																<div class="col-md-6 padding-0">
																	...
																	<div class="">
																		<div class="demo-container">
																			<div dx-data-grid="dataGridOptions8"></div>
																		</div>
																	</div>
																</div>
																<div class="col-md-6 padding-0">
																	...
																	<div class="">
																		<div class="demo-container">
																			<div dx-data-grid="dataGridOptions9"></div>
																		</div>
																	</div>
																</div>
															</div>
							...
							<div class="container margin-top-10 margin-bottom-10">
															...
															<div class="col-md-12 padding-0">
																<div class="col-md-6 padding-0">
																	...
																	<div class="">
																		<div class="demo-container">
																			<div dx-data-grid="dataGridOptions12"></div>
																		</div>
																	</div>
																</div>
																<div class="col-md-6 padding-0">
																	...
																	<div class="">
																		<div class="demo-container">
																			<div dx-data-grid="dataGridOptions13"></div>
																		</div>
																	</div>
																</div>
															</div>
															...
															<div class="col-md-12 padding-0">
																<div class="col-md-6 padding-0">
																	...
																	<div class="">
																		<div class="demo-container">
																			<div dx-data-grid="dataGridOptions14"></div>
																		</div>
																	</div>
																</div>
																<div class="col-md-6 padding-0">
																	...
																	<div class="">
																		<div class="demo-container">
																			<div dx-data-grid="dataGridOptions15"></div>
																		</div>
																	</div>
																</div>
															</div>
					...
					<div class="tab-content clearfix">
						...
						<div class="border-top-bottom-ddd col-md-12 padding-0">
                            ...
                            <tr>
                              ...
                              <tr>
                                <td class="header-td">Medical Claims</td>
                                <td class="column-1 column-td" id="1">$200</td>
                                <td class="column-2 column-td" id="2">$50</td>
                                <td class="column-3 column-td" id="3">$250</td>
                                <td class="column-4 column-td" id="4">$250</td>
                              ...
                              <tr>
                              <td class="header-td">Pharmacy Claims</td>
                                <td class="column-1 column-td" id="1">$200</td>
                                <td class="column-2 column-td" id="2">$50</td>
                                <td class="column-3 column-td" id="3">$250</td>
                                <td class="column-4 column-td" id="4">$250</td>
                              ...
                              <tr>
                               <td class="header-td">Dental Claims</td>
                               <td class="column-1 column-td" id="1">$200</td>
                                <td class="column-2 column-td" id="2">$50</td>
                                <td class="column-3 column-td" id="3">$250</td>
                                <td class="column-4 column-td" id="4">$250</td>
                              ...
                              <tr>
                               <td class="header-td">HSA Claims</td>
                               <td class="column-1 column-td" id="1">$200</td>
                                <td class="column-2 column-td" id="2">$50</td>
                                <td class="column-3 column-td" id="3">$250</td>
                                <td class="column-4 column-td" id="4">$250</td>
                              ...
                              <tr>
                               <td class="header-td">Stop Loss Reimbursement</td>
                               <td class="column-1 column-td" id="1">$200</td>
                                <td class="column-2 column-td" id="2">$50</td>
                                <td class="column-3 column-td" id="3">$250</td>
                                <td class="column-4 column-td" id="4">$250</td>
                             ...
                             <tr>
                               <td class="header-td">Drug Debates</td>
                               <td class="column-1 column-td" id="1">$200</td>
                                <td class="column-2 column-td" id="2">$50</td>
                                <td class="column-3 column-td" id="3">$250</td>
                                <td class="column-4 column-td" id="4">$250</td>
                             ...
                             <tr>
                               <td class="header-td">Stop Loss Premiums</td>
                               <td class="column-1 column-td" id="1">$200</td>
                                <td class="column-2 column-td" id="2">$50</td>
                                <td class="column-3 column-td" id="3">$250</td>
                                <td class="column-4 column-td" id="4">$250</td>
                             ...
                             <tr>
                               <td class="header-td">Wellness Credits</td>
                               <td class="column-1 column-td" id="1">$200</td>
                                <td class="column-2 column-td" id="2">$50</td>
                                <td class="column-3 column-td" id="3">$250</td>
                                <td class="column-4 column-td" id="4">$250</td>
						...
						<div class="border-top-bottom-ddd col-md-12 padding-0">
							...
							<div class="col-md-2 col-xs-3 padding-left-8"><label class="margin-top-10"> Plan Year Data As of :</label></div>
								...
								<a class="color-blue"> <u class="pull-right" id="create-claim" href="#create_claim"
										data-toggle="modal">Add New Claim</u></a>
								</div>
								</div>
								</div>
															<div class="col-md-12 padding-0">
															...
															<?php
$resultData = [
    array("claiminantid"=>"789786","status"=>"Active","memtype"=>"Employee","age"=>"47","Gender"=>"Male","planclaims"=>" 178892","condition"=>"Cancer","prognosis"=>" 100000 next Year"),
   array("claiminantid"=>"789786","status"=>"Active","memtype"=>"Employee","age"=>"47","Gender"=>"Male","planclaims"=>" 178892","condition"=>"Cancer","prognosis"=>" 100000 next Year"),
array("claiminantid"=>"789786","status"=>"Active","memtype"=>"Employee","age"=>"47","Gender"=>"Male","planclaims"=>" 178892","condition"=>"Cancer","prognosis"=>" 100000 next Year"),
array("claiminantid"=>"789786","status"=>"Active","memtype"=>"Employee","age"=>"47","Gender"=>"Male","planclaims"=>"178892","condition"=>"Cancer","prognosis"=>" 100000 next Year"),
array("claiminantid"=>"789786","status"=>"Active","memtype"=>"Employee","age"=>"47","Gender"=>"Male","planclaims"=>" 178892","condition"=>"Cancer","prognosis"=>" 100000 next Year"),
...
'headerOptions' => ['class' => 'blue-grid-head no-wrap'],
//'width'=>'150px',
// 'pageSummary' => true,
 // 'format' => ['currency', ''],
//'mergeHeader'=>true
...
$filteredresultData = array_filter($resultData, 'filter_3');
