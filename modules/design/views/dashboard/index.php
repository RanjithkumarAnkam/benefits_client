				...
				<div>
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item"><a class="nav-link link active color-white backcolor"
							...
							data-target="#home5" role="tab">Financial and Basic Statistics</a>
						</li>
						<li class="nav-item"><a class="nav-link link color-white backcolor"
							href="javascript: void(0);" data-toggle="tab"
							data-target="#profile5" role="tab">User Analytics</a></li>
						<li class="nav-item"><a class="nav-link link color-white redrawchart backcolor"
							href="javascript: void(0);" data-toggle="tab" 
							data-target="#messages5" role="tab">Firm And Client Analytics</a>
						</li>
	...
	/*	],
		...
		'footer' => false,
			...
			<tr class="tr-back">
				...
				<td class="td-back"><a href="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/design/user/firmuser?id=1" class="color-blue"><u>Firm1</u></td> 
...
$(document).ready(function (){
	 $("#most_active .dx-toolbar-before").html('<strong class="">Most Active Users</strong>');
	  $("#application_funtionality .dx-toolbar-before").html('<strong class="">Application Functionality</strong>');
	   $("#help_needed .dx-toolbar-before").html('<strong class="">Help Needed By users</strong>');
	    $("#largest_firm .dx-toolbar-before").html('<strong class="">Largest Firms On Application</strong>');
});
